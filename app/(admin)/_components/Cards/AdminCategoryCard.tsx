   ...
   return (
      <div className="h-[380px] w-full rounded-lg shadow-card flex flex-col justify-between  relative">
         ...
         <div className="w-full h-full p-2 mt-10 flex flex-col gap-2">
            <span className=" text-sm font-semibold text-primary-dark">{category.name}</span>
            <span className=" text-xs text-primary-dark/70 line-clamp-2   ">{category.description}</span>
         </div>
