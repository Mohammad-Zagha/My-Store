   ...
   return (
      ...
      >
         <div className="space-y-0.75r max-md:w-full max-md:text-center">
            <span className=" text-xl font-semibold">تسجيل الدخول</span>
            <p className="text-sm  text-primary-light">ادخل بياناتك لتسجيل الدخول</p>
         </div>
         <AdminLoginForm />
         <span className="text-center text-xs  text-primary-light">اتصل على 0569748922 في حال نسيت كلمة السر</span>
